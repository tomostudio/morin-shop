...
const HomeTabsDesktop = ({ tabData, onChangeCategory, className = '' }) => {
  ...
  return (
    <nav
      className={`header-nav w-fit pointer-events-auto text-default relative rounded-full bg-white py-1.5 px-2 shadow-softer flex justify-around lg:justify-start ${className}`}
