  ...
  return (
    <div className="max-w-md w-full mt-3 mx-auto">
      <form method="post" onSubmit={onPayment} className="space-y-3">
        ...
        <div className="relative w-full">
          <label className="block border-2 border-morin-blue rounded-full text-morin-blue font-semibold px-5 pt-2.5 pb-2 w-full cursor-pointer">
            {getName ? getName : 'Proof of Transfer'}
            <div className="absolute top-0 right-0 h-full border-2 cursor-pointer hover:bg-morin-blue hover:text-white hover:shadow-softer duration-300 transition-all border-morin-blue rounded-full px-5 pt-2.5 pb-2">
              Select File
            </div>
            <input
              name="foto_transfer"
