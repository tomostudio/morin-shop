      ...
      >
        {tabData?.map((item) => (
          ...
          >
            ...
            />
            <label
              className='radio-switch__label font-medium relative flex items-center justify-center h-full rounded-full leading-none select-none z-2 cursor-pointer transition-all duration-300 pt-[2px]'
              htmlFor={item.id}
            >
              {item.title}
            </label>
