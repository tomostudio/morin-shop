  ...
  return (
    <div className="flex flex-col w-full">
      <div className="w-full border-y-2 border-morin-blue">
        {data.map((item, index) => (
          <div className={`${index > 0 ? "mb-6" : "my-6"} mx-4 w-full flex`} key={index}>
            ...
            <div className="flex flex-col w-full ml-6 text-morin-blue">
              ...
              <span className="font-medium text-[12px]">{item.weight}</span>
              <span className="font-semibold text-[12px]">IDR 39.000,-</span>
