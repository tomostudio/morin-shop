  ...
  return (
    <Layout>
      ...
      <div className="bg-morin-skyBlue w-full">
        <HeaderGap />
        <Container className=" grid grid-cols-2 lg:grid-cols-4 gap-6 my-14 lg:my-20">
          <FancyLink
          ...
          >
            ...
            <div className="relative text-morin-blue text-center px-4 lg:px-14 pt-8 pb-4 lg:pt-8 lg:pb-4 z-1 md:pt-12 lg:pb-5 xl:pb-8">
              <div className="font-nutmeg text-default text-[12px] md:text-[18px]">
